CLASS zcl_rap100_gen_data_583 DEFINITION
PUBLIC
  FINAL
  CREATE PUBLIC.
...
CLASS zcl_rap100_gen_data_583 IMPLEMENTATION.
  METHOD if_oo_adt_classrun~main.
    DATA group_id   TYPE string VALUE '583'.
    DATA attachment TYPE /dmo/attachment.
    DATA file_name  TYPE /dmo/filename.
    DATA mime_type  TYPE /dmo/mime_type.

    " clear data
    DELETE FROM zrap100_atrav583.
*    DELETE FROM zrap100_dtrav583.

    " insert travel demo data
    INSERT zrap100_atrav583 FROM (
        SELECT

"! @testing BDEF:ZRAP100_R_TravelTP_583
CLASS zrap100_tc_travel_eml_583 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC
  FOR TESTING
...
CLASS zrap100_tc_travel_eml_583 IMPLEMENTATION.
  METHOD class_setup.
    " create the test doubles for the underlying CDS entities
    cds_test_environment = cl_cds_test_environment=>create_for_multiple_cds(
                               i_for_entities = VALUE #( ( i_for_entity = 'ZR_RAP100_ATRAV583' ) ) ).
  ...
  METHOD create_with_action.
    ...
    MODIFY ENTITIES OF zr_rap100_atrav583
           ENTITY Travel
    ...
    SELECT * FROM zr_rap100_atrav583 INTO TABLE @DATA(lt_travel). "#EC CI_NOWHERE
